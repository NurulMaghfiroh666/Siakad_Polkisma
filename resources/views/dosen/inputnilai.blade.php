...
@section('title', 'Isi Nilai - Dashboard Dosen')
...
<div class="page-header">
    <h1 class="page-title">Isi Nilai Mahasiswa</h1>
    <p class="page-subtitle">Pilih mata kuliah untuk mengisi nilai mahasiswa</p>
</div>
