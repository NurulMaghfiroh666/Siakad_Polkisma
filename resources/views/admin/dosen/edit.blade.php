...
<div class="space-y-6">
    <div class="flex items-center">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-1">Update data dosen</p>
        </div>
    </div>

    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('admin.dosen.update', $dosen->IdDosen) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="NoTelpon" id="NoTelpon" value="{{ old('NoTelpon', $dosen->NoTelpon) }}" required
