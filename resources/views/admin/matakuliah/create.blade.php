...
<div class="space-y-6">
    <div class="flex items-center">
        ...
        <div>
            ...
            <p class="text-gray-600 mt-1">Masukkan data mata kuliah baru</p>
        </div>
    </div>
        ...
        <form action="{{ route('admin.matakuliah.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="KodeMK" id="KodeMK" value="{{ old('KodeMK') }}" required
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="NamaMK" id="NamaMK" value="{{ old('NamaMK') }}" required
    ...
    <div class="bg-purple-50 border-l-4 border-purple-500 p-4 rounded">
        <div class="flex">
            ...
            <p class="text-purple-700 text-sm">Kode MK harus unik dan tidak boleh sama dengan mata kuliah yang sudah ada</p>
        </div>
    </div>
</div>
@endsection
